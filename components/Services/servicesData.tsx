...
const servicesData: Service[] = [
  {
    id: 1,
    icon: <img src="/images/services/icons8-hosting-100.png" alt="Startup Icon" width="40" height="40" />, // Use the imported image variable
    title: "Crafted for Startups",
    paragraph:
      "Tuae nam ex similique incidunt expedita exerci tationem laudantium. Repellendus quisquam numquam perferendis earum sapiente non tempore? Fugit repellat ut maiores.",
  },
  ...
  {
    id: 3,
    icon: <img src="/images/logo/gikoriginal.png" alt="Next.js Icon" width="40" height="40" />, // Use the imported image variable
    title: "Next.js 13 (Latest)",
    paragraph:
      "Tuae nam ex similique incidunt expedita exerci tationem laudantium. Repellendus quisquam numquam perferendis earum sapiente non tempore? Fugit repellat ut maiores.",
  },
