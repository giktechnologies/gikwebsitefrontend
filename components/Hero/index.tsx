...
const Hero = () => {
  ...
  GIK&apos;s mission is to be a world-class ICT company that provides cutting-edge solutions through technological innovations and .
</p>
                  ...
                  <div className="mt-7">
                    ...
                    <ButtonLink href="/signup" color = "white">
                      Contact Us
                    </ButtonLink>
...
const ButtonLink = ({ href, children, color = 'blue', className = '' }) => {
